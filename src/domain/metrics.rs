...
pub struct MonitorMetrics {
    ...
    pub left_buy_right_sell_open_spread_max_30m_bps: Option<f64>,
    pub left_buy_right_sell_close_spread_min_30m_bps: Option<f64>,
    pub right_buy_left_sell_open_spread_max_30m_bps: Option<f64>,
    pub right_buy_left_sell_close_spread_min_30m_bps: Option<f64>,
